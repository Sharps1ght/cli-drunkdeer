...
// Per-model LED grids in row-major order, matching the webdriver's getXxx() iteration
...
func GetLEDGrid(model string) [][]int {
	switch model {
	case KEYBOARD_G60:
		return G60_LED_GRID
	case KEYBOARD_G65:
